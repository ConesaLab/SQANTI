...
Moreover, SQANTI adds another functionality, SQANTI filtering function, that allows user to filter out artifact transcripts by taking advantage of SQANTI-provided attributes and Machine Learning methods.
