...
def main():
	...
	parser.add_argument('-t', '--gmap_threads', help='\t\tNumber of threads used during sequence alignment by gmap.', required=False, default="1", type=int)
	parser.add_argument('-z', '--sense', help='\t\tOption that helps GMAP know that the exons in you cDNA sequences are in the correct sense. Applicable just when you have a high quality set of cDNA sequences', required=False, action='store_true')
